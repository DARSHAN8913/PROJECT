...
const char* ssid     = "D21";   //your network SSID
const char* password = "Gty@6464";   //your network password

String myScript1 = "/macros/s/AKfycbzmyFDuxX5VxiNhicQbMIAh6Vx_ePcYCYfXvxg5Oov5gV-JJMI7QbOvwzqeE2VkdgBHaQ/exec";    //Create your Google Apps Script and replace the "myScript" path.
...
String SendCapturedImage() {
  ...
  if (client_tcp.connect(myDomain, 443)) {
    ...
    client_tcp.println("POST " + myScript1 + " HTTP/1.1");

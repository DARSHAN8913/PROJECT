...
String myDeploymentID = "AKfycbznSxG5GdwF6jvVTkWlyKrGUluZfLhEftAPmv4azDsL-q-BN7_uhjLKvLhTFrhT2OSBvQ";
String myMainFolderName = "ESP32-CAM";
//======================================== 

//======================================== Variables for Timer/Millis.
unsigned long previousMillis = 0; 
// const int Interval = 2000; //--> Capture and Send a photo every 20 seconds.
//======================================== 
int pipin=13;
...
bool LED_Flash_ON = true,pif=false;
